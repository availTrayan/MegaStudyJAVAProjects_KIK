...
//		예) 어린왕자의 작가명은 생텍쥐페리
        ...
        Set<String> bookmapSet = bookMap.keySet();
     
        for(String key : bookmapSet) {
        	
        	// 책이름으로 작가이름을 얻을수 있는 맵
        	Map<String, String> genre = bookMap.get(key);
        	
        		if(genre.containsKey(searchBook)) {
        	
        		String writer = genre.get(searchBook);
        		
        		System.out.println(searchBook + "의 작가는 " + writer + "입니다.");
        		}
          }
       }
